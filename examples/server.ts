...
import { AsymmetricRatchet, Identity, MessageSignedProtocol } from "..";
import { IdentityProtocol, PreKeyBundleProtocol, PreKeyMessageProtocol } from "..";
...
export class Server extends EventEmitter {
  ...
  public static async create(id: number) {
    ...
    server.bundle.preKeySigned.id = 0;
