...
### WARNING
Though this protocol is based on [The Double Ratchet Algorithm](https://whispersystems.org/docs/specifications/doubleratchet/) and [The X3DH Key Agreement Protocol](https://whispersystems.org/docs/specifications/x3dh/) several changes have been made that could change the security properties of the protocol. At this time you should consider this protocol appropriate for experimentation until further security reviews are completed.
